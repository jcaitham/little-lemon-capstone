        ...
        <>
            ...
            <section className="primaryGreen backgroundBanner background" style={{marginBottom: 100}}>
                <div className="content standardTopMargin" style={{display: "flex", gap: 40}}>
                    ...
                    <img src={chefImage} alt="Two chefs laughing while preparing a meal" height="400px" className="shadow" style={{aspectRatio: "1/1", marginTop: -70, transform: "translateY(70px)", borderRadius: "16px", objectFit:"cover"}}/>
                </div>
            </section>
        </>
